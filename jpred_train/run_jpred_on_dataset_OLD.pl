...
#my $cmd = "cd $dir && /homes/www-jpred/live/jpred/jpred --sequence $pwd/$doThisOne.fasta --output $doThisOne";
##my $cmd = "cd $dir && /homes/www-jpred/devel/jpred/jpred --sequence $pwd/$doThisOne.fasta --output $doThisOne --verbose --debug";
my $cmd = "cd $dir && /homes/www-jpred/devel/jpred/jpred_with_hmmer2_with_timing_and_detailed_output --sequence $pwd/$doThisOne.fasta --output $doThisOne --verbose --debug";
